...
import { SafeAreaView, Text, StyleSheet, Platform, TextInput, View, TouchableOpacity, Modal, ActivityIndicator, Alert } from 'react-native';
...
import { callVerifyOtp } from '../services/api';
...
const ForgotEnterOTPScreen = ({ navigation, route }) => {
    ...
    return (
        <SafeAreaView style={styles.root}>
            ...
            <TouchableOpacity
                style={[styles.resendButton, { marginTop: 30 }]}  // Nút để verify OTP
                activeOpacity={0.7}
                onPress={handleVerifyOTP}
            >
                <Text style={styles.resendButtonText}>Xác thực OTP</Text>
            </TouchableOpacity>
